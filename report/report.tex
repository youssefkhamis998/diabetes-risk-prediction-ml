...
% TODO: Describe your custom architecture (number of hidden layers, neurons per layer, activation functions). Mention the use of categorical cross-entropy loss and Softmax activation in the output layer.
...
\begin{table}[H]
    ...
    \begin{tabular}{lcccc}
        ...
        \midrule
        % TODO: Fill in your exact metrics below for FNN
        FNN (Baseline)      & 0.0000 & 0.0000 & 0.0000 & 0.0000 \\
        FNN (SMOTE)         & 0.0000 & 0.0000 & 0.0000 & 0.0000 \\
        FNN (Oversamp.)     & 0.0000 & 0.0000 & 0.0000 & 0.0000 \\
        FNN (Undersamp.)    & 0.0000 & 0.0000 & 0.0000 & 0.0000 \\
        \bottomrule
    \end{tabular}
\end{table}
...
% TODO: If you completed the bonus, include screenshots of your training and validation loss curves here. 

\begin{figure}[H]
    \centering
    % \includegraphics[width=0.7\textwidth]{tensorboard_loss.png}
    \caption{TensorBoard Training and Validation Loss Curves}
\end{figure}

% TODO: Briefly discuss the curves. Do they show signs of overfitting (validation loss increasing while training loss decreases) or underfitting?
