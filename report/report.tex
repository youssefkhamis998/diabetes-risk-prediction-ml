...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{nn_baseline_cm.png}
    \includegraphics[width=0.45\textwidth]{nn_smote_cm.png} \\
    \vspace{0.5cm}
    \includegraphics[width=0.45\textwidth]{nn_overSampling_cm.png}
    \includegraphics[width=0.45\textwidth]{nn_UnderSampling_cm.png}
    \caption{FNN Confusion Matrices: Baseline (top-left), SMOTE (top-right), Oversampling (bottom-left), Undersampling (bottom-right).}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{nn_Smoteen_cm.png}
    \includegraphics[width=0.45\textwidth]{nn_classWeights_cm.png}
    \caption{FNN Confusion Matrices: SMOTEENN (left), Class Weights (right).}
\end{figure}
